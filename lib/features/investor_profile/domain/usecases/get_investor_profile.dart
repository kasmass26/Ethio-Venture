...
class GetInvestorProfile implements UseCase<InvestorProfileEntity?, NoParams> {
  const GetInvestorProfile(this._repository);

  final InvestorProfileRepository _repository;

  @override
  Future<InvestorProfileEntity?> call([NoParams params = const NoParams()]) {
    return _repository.getInvestorProfile();
  }
}
